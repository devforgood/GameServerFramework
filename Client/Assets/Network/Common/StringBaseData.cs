...
public class StringBaseData
{
    ...
    {
        var StringDatas = JsonManager.LoadJsonArray<JStringData>("JsonData", "StringTable_BeforeLobby");
    ...
    public static string GetStringData(string key)
    {
        ...
        StringBaseData._StringDatas.TryGetValue(key.Trim(), out data);
        ...
        switch (StringBaseData.CurrLanguage)
        {
            case "KO":
                return data.Kor;
            case "EN":
