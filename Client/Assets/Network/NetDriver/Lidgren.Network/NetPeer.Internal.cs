...
namespace Lidgren.Network
{
	public partial class NetPeer
	{
		...
		public void ReleaseMessage(NetIncomingMessage msg)
		{
		...
		private void BindSocket(bool reBind)
		{
            ...
            if (m_socket == null)
                m_socket = new Socket((AddressFamily)m_configuration.AddressFamily, SocketType.Dgram, ProtocolType.Udp);

			if (reBind)
			{
				if ((AddressFamily)m_configuration.AddressFamily == AddressFamily.InterNetworkV6)
