...
public struct AddAgent : IFlatbufferObject
{
  ...
  public int AgentId { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static void AddAgentId(FlatBufferBuilder builder, int agentId) { builder.AddInt(2, agentId, 0); }
