...
public struct AddAgent : IFlatbufferObject
{
  ...
  public int ActorId { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }

  public static void StartAddAgent(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static void AddActorId(FlatBufferBuilder builder, int actorId) { builder.AddInt(2, actorId, 0); }
