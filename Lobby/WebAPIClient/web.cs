...
namespace Lobby.WebAPIClient
{
    public class Web
    {
        ...
        static string ServerURL => $"{ServerConfiguration.Instance.config["idp:url"]}{ServerConfiguration.Instance.config["idp:version"]}";
        static string appId => $"{ServerConfiguration.Instance.config["idp:appId"]}";
        static string appSecret => $"{ServerConfiguration.Instance.config["idp:appSecret"]}";

        static string Authorization => $"{ServerConfiguration.Instance.config["idp:Authorization"]}";
        ...
        {
            if (Enable == false)
                return (true, new ResponseValidate());
